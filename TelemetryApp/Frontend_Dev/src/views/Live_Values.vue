...
this.right_inv_containeritems = [
 ...
 { label : ['ctrl_limit_Imax'] },
 { label : ['motor_temp_lousimo'] },
]; 
    ...
    socket.on('telemetry_data', (telemetry_data: api_res) => {
	  ...
	  ////////////     accu     ////////////
			...
			if (this.telemetry_data_obj.accu_avg_cell_temp !== undefined) {
				this.accu_containeritems[45].value = [this.telemetry_data_obj.accu_avg_cell_temp];
			}
			if (this.telemetry_data_obj.accu_soc !== undefined) {
				this.accu_containeritems[46].value = [this.telemetry_data_obj.accu_soc];
			}
////////////     vcu     ////////////
			if (this.telemetry_data_obj.vcu_water_temp_in_right !== undefined) {
				this.vcu_containeritems[0].value = [this.telemetry_data_obj.vcu_water_temp_in_right];
			}
			if (this.telemetry_data_obj.vcu_water_temp_out_right !== undefined) {
				this.vcu_containeritems[1].value = [this.telemetry_data_obj.vcu_water_temp_out_right];
			}
			if (this.telemetry_data_obj.vcu_bspdState !== undefined) {
				this.vcu_containeritems[2].value = [this.telemetry_data_obj.vcu_bspdState];
			}
			if (this.telemetry_data_obj.vcu_fan1 !== undefined) {
				this.vcu_containeritems[3].value = [this.telemetry_data_obj.vcu_fan1];
			}
			if (this.telemetry_data_obj.vcu_fan2 !== undefined) {
				this.vcu_containeritems[4].value = [this.telemetry_data_obj.vcu_fan2];
			}
			if (this.telemetry_data_obj.vcu_apps_right_implausibility !== undefined) {
				this.vcu_containeritems[5].value = [this.telemetry_data_obj.vcu_apps_right_implausibility];
			}
			if (this.telemetry_data_obj.vcu_apps_left_implausibility !== undefined) {
				this.vcu_containeritems[6].value = [this.telemetry_data_obj.vcu_apps_left_implausibility];
			}
			if (this.telemetry_data_obj.vcu_apps_deviation !== undefined) {
				this.vcu_containeritems[7].value = [this.telemetry_data_obj.vcu_apps_deviation];
			}
			if (this.telemetry_data_obj.vcu_water_temp_in_left !== undefined) {
				this.vcu_containeritems[8].value = [this.telemetry_data_obj.vcu_water_temp_in_left];
			}
			if (this.telemetry_data_obj.vcu_water_temp_out_left !== undefined) {
				this.vcu_containeritems[9].value = [this.telemetry_data_obj.vcu_water_temp_out_left];
			}
			if (this.telemetry_data_obj.vcu_yaw_rate_ref !== undefined) {
				this.vcu_containeritems[10].value = [this.telemetry_data_obj.vcu_yaw_rate_ref];
			}
			if (this.telemetry_data_obj.vcu_torque_left !== undefined) {
				this.vcu_containeritems[11].value = [this.telemetry_data_obj.vcu_torque_left];
			}
			if (this.telemetry_data_obj.vcu_torque_right !== undefined) {
				this.vcu_containeritems[12].value = [this.telemetry_data_obj.vcu_torque_right];
			}
			if (this.telemetry_data_obj.vcu_dw !== undefined) {
				this.vcu_containeritems[13].value = [this.telemetry_data_obj.vcu_dw];
			}
			if (this.telemetry_data_obj.vcu_TVtrqLeft !== undefined) {
				this.vcu_containeritems[14].value = [this.telemetry_data_obj.vcu_TVtrqLeft];
			}
			if (this.telemetry_data_obj.vcu_TVtrqRight !== undefined) {
				this.vcu_containeritems[15].value = [this.telemetry_data_obj.vcu_TVtrqRight];
			}
			if (this.telemetry_data_obj.vcu_antiw !== undefined) {
				this.vcu_containeritems[16].value = [this.telemetry_data_obj.vcu_antiw];
			}
			if (this.telemetry_data_obj.vcu_error !== undefined) {
				this.vcu_containeritems[17].value = [this.telemetry_data_obj.vcu_error];
			}
			if (this.telemetry_data_obj.vcu_integral !== undefined) {
				this.vcu_containeritems[18].value = [this.telemetry_data_obj.vcu_integral];
			}
			if (this.telemetry_data_obj.vcu_integral_error !== undefined) {
				this.vcu_containeritems[19].value = [this.telemetry_data_obj.vcu_integral_error];
			}
			if (this.telemetry_data_obj.vcu_m_z_nonsat !== undefined) {
				this.vcu_containeritems[20].value = [this.telemetry_data_obj.vcu_m_z_nonsat];
			}
			if (this.telemetry_data_obj.vcu_m_z_sat !== undefined) {
				this.vcu_containeritems[21].value = [this.telemetry_data_obj.vcu_m_z_sat];
			}
			...
			if (this.telemetry_data_obj.vcu_Ku !== undefined) {
				this.vcu_containeritems[25].value = [this.telemetry_data_obj.vcu_Ku];
			}
			if (this.telemetry_data_obj.vcu_bb !== undefined) {
				this.vcu_containeritems[26].value = [this.telemetry_data_obj.vcu_bb];
			}
			if (this.telemetry_data_obj.vcu_IsdTrqLeft !== undefined) {
				this.vcu_containeritems[27].value = [this.telemetry_data_obj.vcu_IsdTrqLeft];
			}
			if (this.telemetry_data_obj.vcu_IsdTrqRight !== undefined) {
				this.vcu_containeritems[28].value = [this.telemetry_data_obj.vcu_IsdTrqRight];
			}
			if (this.telemetry_data_obj.vcu_deltaW !== undefined) {
				this.vcu_containeritems[29].value = [this.telemetry_data_obj.vcu_deltaW];
			}
			if (this.telemetry_data_obj.vcu_u_x !== undefined) {
				this.vcu_containeritems[30].value = [this.telemetry_data_obj.vcu_u_x];
			}
			if (this.telemetry_data_obj.vcu_pumps_state !== undefined) {
				this.vcu_containeritems[31].value = [this.telemetry_data_obj.vcu_pumps_state];
			}
...
////////////     right_inv     ////////////
			...
			if (this.telemetry_data_obj.vcu_requested_torque_right !== undefined) {
				this.right_inv_containeritems[38].value = [this.telemetry_data_obj.vcu_requested_torque_right];
			}
			if (this.telemetry_data_obj.right_inv_ctrl_limit_Imax !== undefined) {
				this.right_inv_containeritems[39].value = [this.telemetry_data_obj.right_inv_ctrl_limit_Imax];
			}
			if (this.telemetry_data_obj.right_inv_motor_temp_lousimo !== undefined) {
				this.right_inv_containeritems[40].value = [this.telemetry_data_obj.right_inv_motor_temp_lousimo];
			}
////////////     left_inv     ////////////
			if (this.telemetry_data_obj.left_inv_critical_hw_status !== undefined) {
				this.left_inv_containeritems[0].value = [this.telemetry_data_obj.left_inv_critical_hw_status];
			}
			if (this.telemetry_data_obj.left_inv_last_error !== undefined) {
				this.left_inv_containeritems[1].value = [this.telemetry_data_obj.left_inv_last_error];
			}
			if (this.telemetry_data_obj.left_inv_can_state !== undefined) {
				this.left_inv_containeritems[2].value = [this.telemetry_data_obj.left_inv_can_state];
			}
			if (this.telemetry_data_obj.left_inv_sys_status !== undefined) {
				this.left_inv_containeritems[3].value = [this.telemetry_data_obj.left_inv_sys_status];
			}
			if (this.telemetry_data_obj.left_inv_handler_status !== undefined) {
				this.left_inv_containeritems[4].value = [this.telemetry_data_obj.left_inv_handler_status];
			}
			if (this.telemetry_data_obj.left_inv_latched_error !== undefined) {
				this.left_inv_containeritems[5].value = [this.telemetry_data_obj.left_inv_latched_error];
			}
			if (this.telemetry_data_obj.left_inv_actual_inverter_status !== undefined) {
				this.left_inv_containeritems[6].value = [this.telemetry_data_obj.left_inv_actual_inverter_status];
			}
			if (this.telemetry_data_obj.left_inv_act_control_mode !== undefined) {
				this.left_inv_containeritems[7].value = [this.telemetry_data_obj.left_inv_act_control_mode];
			}
			if (this.telemetry_data_obj.left_inv_aux_hw_status !== undefined) {
				this.left_inv_containeritems[8].value = [this.telemetry_data_obj.left_inv_aux_hw_status];
			}
			if (this.telemetry_data_obj.left_inv_id_ref !== undefined) {
				this.left_inv_containeritems[9].value = [this.telemetry_data_obj.left_inv_id_ref];
			}
			if (this.telemetry_data_obj.left_inv_iq_ref !== undefined) {
				this.left_inv_containeritems[10].value = [this.telemetry_data_obj.left_inv_iq_ref];
			}
			if (this.telemetry_data_obj.left_inv_id !== undefined) {
				this.left_inv_containeritems[11].value = [this.telemetry_data_obj.left_inv_id];
			}
			if (this.telemetry_data_obj.left_inv_iq !== undefined) {
				this.left_inv_containeritems[12].value = [this.telemetry_data_obj.left_inv_iq];
			}
			if (this.telemetry_data_obj.left_inv_iq_ref_request !== undefined) {
				this.left_inv_containeritems[13].value = [this.telemetry_data_obj.left_inv_iq_ref_request];
			}
			if (this.telemetry_data_obj.left_inv_vdc_max !== undefined) {
				this.left_inv_containeritems[14].value = [this.telemetry_data_obj.left_inv_vdc_max];
			}
			if (this.telemetry_data_obj.left_inv_vdc !== undefined) {
				this.left_inv_containeritems[15].value = [this.telemetry_data_obj.left_inv_vdc];
			}
			if (this.telemetry_data_obj.left_inv_i1max !== undefined) {
				this.left_inv_containeritems[16].value = [this.telemetry_data_obj.left_inv_i1max];
			}
			if (this.telemetry_data_obj.left_inv_i2max !== undefined) {
				this.left_inv_containeritems[17].value = [this.telemetry_data_obj.left_inv_i2max];
			}
			if (this.telemetry_data_obj.left_inv_i3max !== undefined) {
				this.left_inv_containeritems[18].value = [this.telemetry_data_obj.left_inv_i3max];
			}
			if (this.telemetry_data_obj.left_inv_Imax !== undefined) {
				this.left_inv_containeritems[19].value = [this.telemetry_data_obj.left_inv_Imax];
			}
			if (this.telemetry_data_obj.left_inv_Imin !== undefined) {
				this.left_inv_containeritems[20].value = [this.telemetry_data_obj.left_inv_Imin];
			}
			if (this.telemetry_data_obj.left_inv_trq_ref !== undefined) {
				this.left_inv_containeritems[21].value = [this.telemetry_data_obj.left_inv_trq_ref];
			}
			if (this.telemetry_data_obj.left_inv_pwr_ref !== undefined) {
				this.left_inv_containeritems[22].value = [this.telemetry_data_obj.left_inv_pwr_ref];
			}
			if (this.telemetry_data_obj.left_inv_pwr_actual !== undefined) {
				this.left_inv_containeritems[23].value = [this.telemetry_data_obj.left_inv_pwr_actual];
			}
			if (this.telemetry_data_obj.left_inv_lim_speed_limiter !== undefined) {
				this.left_inv_containeritems[24].value = [this.telemetry_data_obj.left_inv_lim_speed_limiter];
			}
			if (this.telemetry_data_obj.left_inv_lim_power_limiter !== undefined) {
				this.left_inv_containeritems[25].value = [this.telemetry_data_obj.left_inv_lim_power_limiter];
			}
			if (this.telemetry_data_obj.left_inv_lim_stall_limiter !== undefined) {
				this.left_inv_containeritems[26].value = [this.telemetry_data_obj.left_inv_lim_stall_limiter];
			}
			if (this.telemetry_data_obj.left_inv_lim_l2t_limiter !== undefined) {
				this.left_inv_containeritems[27].value = [this.telemetry_data_obj.left_inv_lim_l2t_limiter];
			}
			if (this.telemetry_data_obj.left_inv_lim_motor_temp !== undefined) {
				this.left_inv_containeritems[28].value = [this.telemetry_data_obj.left_inv_lim_motor_temp];
			}
			if (this.telemetry_data_obj.left_inv_lim_igbt_temp !== undefined) {
				this.left_inv_containeritems[29].value = [this.telemetry_data_obj.left_inv_lim_igbt_temp];
			}
			if (this.telemetry_data_obj.left_inv_motor_rpm !== undefined) {
				this.left_inv_containeritems[30].value = [this.telemetry_data_obj.left_inv_motor_rpm];
			}
			if (this.telemetry_data_obj.left_inv_num_max_trq !== undefined) {
				this.left_inv_containeritems[31].value = [this.telemetry_data_obj.left_inv_num_max_trq];
			}
			if (this.telemetry_data_obj.left_inv_vcu_max_velocity !== undefined) {
				this.left_inv_containeritems[32].value = [this.telemetry_data_obj.left_inv_vcu_max_velocity];
			}
			if (this.telemetry_data_obj.left_inv_motor_temp !== undefined) {
				this.left_inv_containeritems[33].value = [this.telemetry_data_obj.left_inv_motor_temp];
			}
			if (this.telemetry_data_obj.left_inv_igbt_temp !== undefined) {
				this.left_inv_containeritems[34].value = [this.telemetry_data_obj.left_inv_igbt_temp];
			}
			if (this.telemetry_data_obj.left_inv_trq_actual !== undefined) {
				this.left_inv_containeritems[35].value = [this.telemetry_data_obj.left_inv_trq_actual];
			}
			if (this.telemetry_data_obj.left_inv_max_velocity !== undefined) {
				this.left_inv_containeritems[36].value = [this.telemetry_data_obj.left_inv_max_velocity];
			}
			if (this.telemetry_data_obj.left_inv_min_velocity !== undefined) {
				this.left_inv_containeritems[37].value = [this.telemetry_data_obj.left_inv_min_velocity];
			}
			if (this.telemetry_data_obj.vcu_requested_torque_left !== undefined) {
				this.left_inv_containeritems[38].value = [this.telemetry_data_obj.vcu_requested_torque_left];
			}
			if (this.telemetry_data_obj.left_inv_ctrl_limit_Imax !== undefined) {
				this.left_inv_containeritems[39].value = [this.telemetry_data_obj.left_inv_ctrl_limit_Imax];
			}
			if (this.telemetry_data_obj.left_inv_motor_temp_lousimo !== undefined) {
				this.left_inv_containeritems[40].value = [this.telemetry_data_obj.left_inv_motor_temp_lousimo];
			}
////////////     dv     ////////////
			...
			if (this.telemetry_data_obj.vcu_initial_check_state !== undefined) {
				this.dv_containeritems[22].value = [this.telemetry_data_obj.vcu_initial_check_state];
			}
////////////     sensors     ////////////
			...
			if (this.telemetry_data_obj.vcu_longitude !== undefined) {
				this.sensors_containeritems[23].value = [this.telemetry_data_obj.vcu_longitude];
			}
			if (this.telemetry_data_obj.vcu_latitude !== undefined) {
				this.sensors_containeritems[24].value = [this.telemetry_data_obj.vcu_latitude];
			}
